...
impl Ecx0x00000001 {
    pub fn get(eax: u32) -> Self {
        ...
        let the_valid_bits_of_secs_attributes_that_software_can_set_with_ecreate: u128 =
            Return::get(eax, ecx)
                .eax_ebx_ecx_edx()
                .into_iter()
                ...
                .fold(
                    0,
                    |the_valid_bits_of_secs_attributes_that_software_can_set_with_ecreate, byte| {
