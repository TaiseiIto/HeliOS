 ...
 *
 * Disassembly of gpd.dsdt.aml, Fri Jul 12 14:58:41 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DD93 (56723)
 *     Revision         0x02
 *     Checksum         0xF4
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x79CB9098, 0x044F)
            ...
            Device (SBRG)
            {
                ...
                Device (SIO1)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        If (IO5B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.SBRG.SIO1._Y08._MIN, GP50)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.SBRG.SIO1._Y08._MAX, GP51)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.SBRG.SIO1._Y08._LEN, GPL5)  // _LEN: Length
                            GP50 = IO5B /* \IO5B */
                            GP51 = IO5B /* \IO5B */
                            GPL5 = IO5L /* \IO5L */
                        }
                        ...
                        If (IO6B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.SBRG.SIO1._Y09._MIN, GP60)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.SBRG.SIO1._Y09._MAX, GP61)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.SBRG.SIO1._Y09._LEN, GPL6)  // _LEN: Length
                            GP60 = IO6B /* \IO6B */
                            GP61 = IO6B /* \IO6B */
                            GPL6 = IO6L /* \IO6L */
                        }
                    ...
                    CreateWordField (CRS1, \_SB.PCI0.SBRG.SIO1._Y0A._INT, IRQM)  // _INT: Interrupts
                    CreateByteField (CRS1, \_SB.PCI0.SBRG.SIO1._Y0B._DMA, DMAM)  // _DMA: Direct Memory Access
                    CreateWordField (CRS1, \_SB.PCI0.SBRG.SIO1._Y0C._MIN, IO11)  // _MIN: Minimum Base Address
                    CreateWordField (CRS1, \_SB.PCI0.SBRG.SIO1._Y0C._MAX, IO12)  // _MAX: Maximum Base Address
                    CreateByteField (CRS1, \_SB.PCI0.SBRG.SIO1._Y0C._LEN, LEN1)  // _LEN: Length
                    ...
                    CreateWordField (CRS2, \_SB.PCI0.SBRG.SIO1._Y0D._INT, IRQE)  // _INT: Interrupts
                    CreateByteField (CRS2, \_SB.PCI0.SBRG.SIO1._Y0E._DMA, DMAE)  // _DMA: Direct Memory Access
                    CreateWordField (CRS2, \_SB.PCI0.SBRG.SIO1._Y0F._MIN, IO21)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.PCI0.SBRG.SIO1._Y0F._MAX, IO22)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, \_SB.PCI0.SBRG.SIO1._Y0F._LEN, LEN2)  // _LEN: Length
                    CreateWordField (CRS2, \_SB.PCI0.SBRG.SIO1._Y10._MIN, IO31)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.PCI0.SBRG.SIO1._Y10._MAX, IO32)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, \_SB.PCI0.SBRG.SIO1._Y10._LEN, LEN3)  // _LEN: Length
                    ...
                    CreateWordField (CRS3, \_SB.PCI0.SBRG.SIO1._Y11._INT, IRQT)  // _INT: Interrupts
                    CreateByteField (CRS3, \_SB.PCI0.SBRG.SIO1._Y11._HE, IRQS)  // _HE_: High-Edge
                    CreateByteField (CRS3, \_SB.PCI0.SBRG.SIO1._Y12._DMA, DMAT)  // _DMA: Direct Memory Access
                    CreateWordField (CRS3, \_SB.PCI0.SBRG.SIO1._Y13._MIN, IO41)  // _MIN: Minimum Base Address
                    CreateWordField (CRS3, \_SB.PCI0.SBRG.SIO1._Y13._MAX, IO42)  // _MAX: Maximum Base Address
                    CreateByteField (CRS3, \_SB.PCI0.SBRG.SIO1._Y13._LEN, LEN4)  // _LEN: Length
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        Name (RBUF, ResourceTemplate ()
                        {
                            SpiSerialBusV2 (0x0000, PolarityLow, FourWireMode, 0x08,
                                ControllerInitiated, 0x00493E00, ClockPolarityLow,
                        ...
                        Return (RBUF) /* \_SB_.PCI0.SPI1.FP03._CRS.RBUF */
                    }
    ...
    Method (PPTS, 1, NotSerialized)
    {
        ...
        Local1 = \_SB.GPC0 (0x00C50940)
        Local1 &= 0xFFFFFFFFFFFFFFFE
        \_SB.SPC0 (0x00C50940, Local1)
    }
    ...
    Scope (_SB)
    {
        ...
        Device (GPO1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.GPO1._Y15._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.GPO1._Y15._LEN, B0LN)  // _LEN: Length
                B0BA = GP1A /* \GP1A */
                B0LN = GP1L /* \GP1L */
        ...
        Device (GPO0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.GPO0._Y16._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.GPO0._Y16._LEN, B0LN)  // _LEN: Length
                B0BA = GP0A /* \GP0A */
                B0LN = GP0L /* \GP0L */
        ...
        Device (GPO2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.GPO2._Y17._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.GPO2._Y17._LEN, B0LN)  // _LEN: Length
                B0BA = GP2A /* \GP2A */
                B0LN = GP2L /* \GP2L */
        ...
        Device (GPO3)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (RBUF, \_SB.GPO3._Y18._BAS, B0BA)  // _BAS: Base Address
                CreateDWordField (RBUF, \_SB.GPO3._Y18._LEN, B0LN)  // _LEN: Length
                B0BA = GP3A /* \GP3A */
                B0LN = GP3L /* \GP3L */
    ...
    Scope (_SB)
    {
        Device (EPC)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateQWordField (RBUF, \_SB.EPC._Y19._MIN, EMIN)  // _MIN: Minimum Base Address
                CreateQWordField (RBUF, \_SB.EPC._Y19._MAX, EMAX)  // _MAX: Maximum Base Address
                CreateQWordField (RBUF, \_SB.EPC._Y19._LEN, ELEN)  // _LEN: Length
    ...
    Scope (_TZ)
    {
        ...
        ThermalZone (TZ01)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                \_SB.PCI0.SBRG.H_EC.ECWT ((Local0 & 0xFF), RefOf (\_SB.PCI0.SBRG.H_EC.SOCT))
                If ((Local0 & 0x80))
                {
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
        {
            ...
            Else
            {
                ...
                ElseIf ((TTPF == One))
                {
                    If ((TMRQ == Zero))
                    {
                        CreateDWordField (CRID, \_SB.TPM._Y1D._BAS, MTFD)  // _BAS: Base Address
                        CreateDWordField (CRID, \_SB.TPM._Y1D._LEN, LTFD)  // _LEN: Length
                        MTFD = 0xFED40000
                        LTFD = 0x5000
                    ...
                    Else
                    {
                        CreateDWordField (CREI, \_SB.TPM._Y1E._INT, LIRQ)  // _INT: Interrupts
                        LIRQ = TMRQ /* \TMRQ */
                ...
                ElseIf ((TTPF == Zero))
                {
                    CreateDWordField (CRST, \_SB.TPM._Y1B._BAS, MTFF)  // _BAS: Base Address
                    MTFF = FTPM /* \FTPM */
                    Return (CRST) /* \_SB_.TPM_.CRST */
                }
        ...
        Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
        {
            If ((TMRQ != Zero))
            {
                ...
                CreateBitField (CREI, \_SB.TPM._Y1E._HE, LTRG)  // _HE_: High-Edge
                LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                CreateBitField (Arg0, 0x7A, ILVL)
                CreateBitField (CREI, \_SB.TPM._Y1E._LL, LLVL)  // _LL_: Low Level
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (H_EC)
        {
            ...
            {
                Local0 = GPC0 (0x00C50950)
                Local0 ^= One
                SPC0 (0x00C50950, Local0)
            }
            ...
            Device (BAT0)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    BPKG [One] = ((B1DC * B1FV) / 0x03E8)
                    BPKG [0x02] = ((B1FC * B1FV) / 0x03E8)
                    If (B1FC)
                    {
                        Local0 = ((B1FC * B1FV) / 0x03E8)
                        Local1 = ((B1DC * B1FV) / 0x03E8)
                        BPKG [0x05] = (Local0 / 0x0A)
                        BPKG [0x06] = (Local0 / 0x14)
                ...
                Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                {
                    ...
                    Local0 = ((B1FC * BPCN) / 0x64)
                    PKG1 [0x02] = ((Local0 * B1FV) / 0x03E8)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (SBRG.H_EC)
        {
            OperationRegion (IOID, SystemIO, 0x4E, 0x02)
            Field (IOID, ByteAcc, NoLock, Preserve)
            {
                INDX,   8, 
                DATA,   8
            ...
            Device (UAR2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (BUF0) /* \_SB_.PCI0.SBRG.H_EC.UAR2._CRS.BUF0 */
                }
