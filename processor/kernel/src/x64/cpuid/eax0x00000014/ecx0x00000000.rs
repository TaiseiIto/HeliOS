...
struct Ebx {
    ...
    support_of_ip_filtering_tracestop_filtering_and_preservation_of_intel_pt_msrs_across_warm_reset:
        bool,
...
#[bitfield(u32)]
struct Ecx {
    tracing_can_be_enabled_with_ia32_rtit_ctl_topa_1_hence_utilizing_the_topa_output_scheme_ia32_rtit_output_base_and_ia32_rtit_output_mask_ptrs_msrs_can_be_accessed:
        bool,
    topa_tables_can_hold_any_number_of_output_entries_up_to_the_maximum_allowed_by_the_maskortableoffset_field_of_ia32_rtit_output_mask_ptrs:
        bool,
    support_of_single_range_output_scheme: bool,
    support_of_output_to_trace_transport_subsystem: bool,
    #[bits(27)]
    __: u32,
    generated_packets_which_contain_ip_payloads_have_lip_values_which_include_the_cs_base_component:
        bool,
}
