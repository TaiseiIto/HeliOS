...
PROCESSOR_BOOT_LOADER_DESTINATION=$(OS_DIRECTORY)/$(PROCESSOR_BOOT_LOADER_DIRECTORY)/loader.bin
...
PROCESSOR_KERNEL_DESTINATION=$(OS_DIRECTORY)/$(PROCESSOR_KERNEL_DIRECTORY)/kernel.elf
...
$(TARGET): $(shell find . -type f | grep -v ^.*/\.git/.*$ | grep -vf <(git ls-files --exclude-standard --ignored -o))
	...
	make $(BOOTLOADER_DESTINATION) PROCESSOR_BOOT_LOADER=$(PROCESSOR_BOOT_LOADER) PROCESSOR_BOOT_LOADER_BASE=$(PROCESSOR_BOOT_LOADER_BASE) PROCESSOR_BOOT_LOADER_STACK_FLOOR=$(PROCESSOR_BOOT_LOADER_STACK_FLOOR) KERNEL=$(KERNEL) SUDO=$(SUDO)
...
$(MOUNT_DIRECTORY): $(shell find . -type f | grep -v ^.*/\.git/.*$ | grep -vf <(git ls-files --exclude-standard --ignored -o))
	...
	make $(BOOTLOADER_DESTINATION) PROCESSOR_BOOT_LOADER=$(PROCESSOR_BOOT_LOADER) PROCESSOR_BOOT_LOADER_BASE=$(PROCESSOR_BOOT_LOADER_BASE) PROCESSOR_BOOT_LOADER_STACK_FLOOR=$(PROCESSOR_BOOT_LOADER_STACK_FLOOR) KERNEL=$(KERNEL)
