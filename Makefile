...
APPLICATION_PROCESSOR_BOOT_LOADER=$(shell echo $(APPLICATION_PROCESSOR_BOOT_LOADER_DESTINATION) | cut -d '/' -f 2-)
...
$(TARGET): $(shell find . -type f | grep -v ^.*/\.git/.*$ | grep -vf <(git ls-files --exclude-standard --ignored -o))
	...
	make $(BOOTLOADER_DESTINATION) APPLICATION_PROCESSOR_BOOT_LOADER=$(APPLICATION_PROCESSOR_BOOT_LOADER) APPLICATION_PROCESSOR_BOOT_LOADER_BASE=$(APPLICATION_PROCESSOR_BOOT_LOADER_BASE) APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR=$(APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR) KERNEL=$(KERNEL) SUDO=$(SUDO)
...
$(MOUNT_DIRECTORY): $(shell find . -type f | grep -v ^.*/\.git/.*$ | grep -vf <(git ls-files --exclude-standard --ignored -o))
	...
	make $(BOOTLOADER_DESTINATION) APPLICATION_PROCESSOR_BOOT_LOADER=$(APPLICATION_PROCESSOR_BOOT_LOADER) APPLICATION_PROCESSOR_BOOT_LOADER_BASE=$(APPLICATION_PROCESSOR_BOOT_LOADER_BASE) APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR=$(APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR) KERNEL=$(KERNEL)
...
$(BOOTLOADER_SOURCE): $(shell find $(BOOTLOADER_DIRECTORY) -type f | grep -v ^.*/\.git/.*$ | grep -vf <(git ls-files --exclude-standard --ignored -o))
	make -C $(BOOTLOADER_DIRECTORY) APPLICATION_PROCESSOR_BOOT_LOADER=$(APPLICATION_PROCESSOR_BOOT_LOADER) APPLICATION_PROCESSOR_BOOT_LOADER_BASE=$(APPLICATION_PROCESSOR_BOOT_LOADER_BASE) APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR=$(APPLICATION_PROCESSOR_BOOT_LOADER_STACK_FLOOR) KERNEL=$(KERNEL)
