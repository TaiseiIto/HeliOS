...
impl Registers {
    pub fn disable_periodic_interrupt(&mut self) {
        let configuration_and_capability: configuration_and_capability::Register = self
    ...
    pub fn is_enable(&self) -> bool {
        let configuration_and_capability: configuration_and_capability::Register =
...
impl fmt::Debug for Registers {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        let configuration_and_capability: configuration_and_capability::Register =
            self.configuration_and_capability;
        let configuration_and_capability: configuration_and_capability::Controller =
            (&configuration_and_capability).into();
