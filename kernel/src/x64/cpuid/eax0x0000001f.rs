...
struct Eax {
    #[bits(5)]
    the_number_of_bits_that_the_x2apic_id_must_be_shifted_to_the_right_to_address_instance_of_the_next_higher_scoped_domain:
        u8,
    #[bits(27)]
    __: u32,
}
...
#[bitfield(u32)]
struct Ebx {
    the_number_of_logical_processors_across_all_instances_of_this_domain_within_the_next_higher_scoped_domain_relative_to_this_current_logical_processor:
        u16,
    __: u16,
}
