...
pub struct Structure {
    ...
    device_status: device::status::Register,
    ...
    root_capabilities: root::capabilities::Register,
...
impl fmt::Debug for Structure {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let device_status: device::status::Register = self.device_status;
        ...
        let root_capabilities: root::capabilities::Register = self.root_capabilities;
